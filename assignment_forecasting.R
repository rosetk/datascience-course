library(readr)
Airlines<-read.csv(file.choose()) # read the Airline  data
View(Airlines )
windows()
...
View(x)
trakdata1<-cbind(Airlines,x)
View(trakdata1)
colnames(trakdata1)
trakdata1["t"]<- 1:96
View(trakdata1)
trakdata1["log_passenger"]<-log(trakdata1["Passengers"])
trakdata1["t_square"]<-trakdata1["t"]*trakdata1["t"]
attach(trakdata1)

train<-trakdata1[1:85,]

test<-trakdata1[86:96,]
