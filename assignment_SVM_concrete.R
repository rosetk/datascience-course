...
mean(pred_vanilla==letters_test$lettr) 
head(pred_vanilla)
View(letters_test)
table(pred_vanilla,letters_test$lettr)
agreement <- pred_vanilla == letters_test$lettr
table(agreement)
...
mean(pred_rfdot==letters_test$lettr) 
head(pred_rfdot)
View(letters_test)
table(pred_rfdot,letters_test$lettr)
agreement <- pred_rfdot == letters_test$lettr
table(agreement)
prop.table(table(agreement))
