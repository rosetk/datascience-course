...
table(pred_rfdot,FF_test$size_category)
agreement <- pred_rfdot == FF_test$size_category
table(agreement)
prop.table(table(agreement))
...
agreement <- pred_vanilla == FF_test$size_category
table(agreement)
prop.table(table(agreement))
...
agreement <- pred_bessel == FF_test$size_category
table(agreement)
prop.table(table(agreement))
...
agreement <- pred_poly == FF_test$size_category
table(agreement)
prop.table(table(agreement))
